...
<html lang="en">
  ...
  <meta property="fb:app_id" content="1401488693436528">
    ...
    <meta name="twitter:image:src" content="https://avatars3.githubusercontent.com/u/374060?s=400&amp;v=4" /><meta name="twitter:site" content="@github" /><meta name="twitter:card" content="summary" /><meta name="twitter:title" content="dmuth/wordpress-with-nginx-and-letsencrypt" /><meta name="twitter:description" content="Install WordPress in Docker with Nginx, PHP-FPM, and LetsEncrypt for HTTPS! - dmuth/wordpress-with-nginx-and-letsencrypt" />
    <meta property="og:image" content="https://avatars3.githubusercontent.com/u/374060?s=400&amp;v=4" /><meta property="og:site_name" content="GitHub" /><meta property="og:type" content="object" /><meta property="og:title" content="dmuth/wordpress-with-nginx-and-letsencrypt" /><meta property="og:url" content="https://github.com/dmuth/wordpress-with-nginx-and-letsencrypt" /><meta property="og:description" content="Install WordPress in Docker with Nginx, PHP-FPM, and LetsEncrypt for HTTPS! - dmuth/wordpress-with-nginx-and-letsencrypt" />
...
<meta class="js-ga-set" name="dimension1" content="Logged Out">
  ...
  <meta name="html-safe-nonce" content="01fa8b2020b3f387b3a94d2a953d02835396a0bb">

  <meta http-equiv="x-pjax-version" content="eebadb79980e31602c9071d050b11f46">
  

      <link href="https://github.com/dmuth/wordpress-with-nginx-and-letsencrypt/commits/master.atom" rel="alternate" title="Recent Commits to wordpress-with-nginx-and-letsencrypt:master" type="application/atom+xml">

  <meta name="go-import" content="github.com/dmuth/wordpress-with-nginx-and-letsencrypt git https://github.com/dmuth/wordpress-with-nginx-and-letsencrypt.git">
...
<meta name="theme-color" content="#1e2327">
  ...
  <div class="container-lg d-lg-flex flex-items-center p-responsive">
    ...
    <a class="Header-link" href="/dmuth">dmuth</a>
    /
    <a class="Header-link" href="/dmuth/wordpress-with-nginx-and-letsencrypt">wordpress-with-nginx-and-letsencrypt</a>
...
>
  <div class="position-relative">
    <!-- '"` --><!-- </textarea></xmp> --></option></form><form class="js-site-search-form" role="search" aria-label="Site" data-scope-type="Repository" data-scope-id="161568856" data-scoped-search-url="/dmuth/wordpress-with-nginx-and-letsencrypt/search" data-unscoped-search-url="/search" action="/dmuth/wordpress-with-nginx-and-letsencrypt/search" accept-charset="UTF-8" method="get"><input name="utf8" type="hidden" value="&#x2713;" />
...
<li class="d-flex flex-justify-start flex-items-center p-0 f5 navigation-item js-navigation-item js-jump-to-global-search d-none" role="option">
  ...
  <li>
    ...
    <a class="social-count js-social-count" href="/dmuth/wordpress-with-nginx-and-letsencrypt/stargazers"
  ...
  <li>
    ...
    <a href="/dmuth/wordpress-with-nginx-and-letsencrypt/network/members" class="social-count"
      ...
      <h1 class="public ">
    <svg class="octicon octicon-repo" viewBox="0 0 12 16" version="1.1" width="12" height="16" aria-hidden="true"><path fill-rule="evenodd" d="M4 9H3V8h1v1zm0-3H3v1h1V6zm0-2H3v1h1V4zm0-2H3v1h1V2zm8-1v12c0 .55-.45 1-1 1H6v2l-1.5-1.5L3 16v-2H1c-.55 0-1-.45-1-1V1c0-.55.45-1 1-1h10c.55 0 1 .45 1 1zm-1 10H1v2h2v-1h3v1h5v-2zm0-10H2v9h9V1z"/></svg>
  <span class="author" itemprop="author"><a class="url fn" rel="author" data-hovercard-type="user" data-hovercard-url="/hovercards?user_id=374060" data-octo-click="hovercard-link-click" data-octo-dimensions="link_type:self" href="/dmuth">dmuth</a></span><!--
--><span class="path-divider">/</span><!--
--><strong itemprop="name"><a data-pjax="#js-repo-pjax-container" href="/dmuth/wordpress-with-nginx-and-letsencrypt">wordpress-with-nginx-and-letsencrypt</a></strong>
...
<nav class="hx_reponav reponav js-repo-nav js-sidenav-container-pjax container-lg p-responsive d-none d-lg-block"
  ...
  <span itemscope itemtype="http://schema.org/ListItem" itemprop="itemListElement">
    <a class="js-selected-navigation-item selected reponav-item" itemprop="url" data-hotkey="g c" aria-current="page" data-selected-links="repo_source repo_downloads repo_commits repo_releases repo_tags repo_branches repo_packages /dmuth/wordpress-with-nginx-and-letsencrypt" href="/dmuth/wordpress-with-nginx-and-letsencrypt">
    ...
    <span itemscope itemtype="http://schema.org/ListItem" itemprop="itemListElement">
      <a itemprop="url" data-hotkey="g i" class="js-selected-navigation-item reponav-item" data-selected-links="repo_issues repo_labels repo_milestones /dmuth/wordpress-with-nginx-and-letsencrypt/issues" href="/dmuth/wordpress-with-nginx-and-letsencrypt/issues">
  ...
  <span itemscope itemtype="http://schema.org/ListItem" itemprop="itemListElement">
    <a data-hotkey="g p" itemprop="url" class="js-selected-navigation-item reponav-item" data-selected-links="repo_pulls checks /dmuth/wordpress-with-nginx-and-letsencrypt/pulls" href="/dmuth/wordpress-with-nginx-and-letsencrypt/pulls">
    ...
    <a data-hotkey="g b" class="js-selected-navigation-item reponav-item" data-selected-links="repo_projects new_repo_project repo_project /dmuth/wordpress-with-nginx-and-letsencrypt/projects" href="/dmuth/wordpress-with-nginx-and-letsencrypt/projects">
    ...
    <a data-skip-pjax="true" class="js-selected-navigation-item reponav-item" data-selected-links="security alerts policy code_scanning /dmuth/wordpress-with-nginx-and-letsencrypt/security/advisories" href="/dmuth/wordpress-with-nginx-and-letsencrypt/security/advisories">
      <svg class="octicon octicon-shield" viewBox="0 0 14 16" version="1.1" width="14" height="16" aria-hidden="true"><path fill-rule="evenodd" d="M0 2l7-2 7 2v6.02C14 12.69 8.69 16 7 16c-1.69 0-7-3.31-7-7.98V2zm1 .75L7 1l6 1.75v5.268C13 12.104 8.449 15 7 15c-1.449 0-6-2.896-6-6.982V2.75zm1 .75L7 2v12c-1.207 0-5-2.482-5-5.985V3.5z"/></svg>
      Security
</a>
    <a class="js-selected-navigation-item reponav-item" data-selected-links="repo_graphs repo_contributors dependency_graph pulse people /dmuth/wordpress-with-nginx-and-letsencrypt/pulse" href="/dmuth/wordpress-with-nginx-and-letsencrypt/pulse">
  ...
  <nav class="reponav js-reponav text-center no-wrap"
    ...
    <span itemscope itemtype="http://schema.org/ListItem" itemprop="itemListElement">
      <a class="js-selected-navigation-item selected reponav-item" itemprop="url" aria-current="page" data-selected-links="repo_source repo_downloads repo_commits repo_releases repo_tags repo_branches repo_packages /dmuth/wordpress-with-nginx-and-letsencrypt" href="/dmuth/wordpress-with-nginx-and-letsencrypt">
        <span itemprop="name">Code</span>
        <meta itemprop="position" content="1">
</a>    </span>

      <span itemscope itemtype="http://schema.org/ListItem" itemprop="itemListElement">
        <a itemprop="url" class="js-selected-navigation-item reponav-item" data-selected-links="repo_issues repo_labels repo_milestones /dmuth/wordpress-with-nginx-and-letsencrypt/issues" href="/dmuth/wordpress-with-nginx-and-letsencrypt/issues">
          <span itemprop="name">Issues</span>
          <span class="Counter">0</span>
          <meta itemprop="position" content="2">
</a>      </span>
    ...
    <span itemscope itemtype="http://schema.org/ListItem" itemprop="itemListElement">
      <a itemprop="url" class="js-selected-navigation-item reponav-item" data-selected-links="repo_pulls checks /dmuth/wordpress-with-nginx-and-letsencrypt/pulls" href="/dmuth/wordpress-with-nginx-and-letsencrypt/pulls">
        <span itemprop="name">Pull requests</span>
        <span class="Counter">0</span>
        <meta itemprop="position" content="3">
</a>    </span>
      ...
      <span itemscope itemtype="http://schema.org/ListItem" itemprop="itemListElement">
        <a itemprop="url" class="js-selected-navigation-item reponav-item" data-selected-links="repo_projects new_repo_project repo_project /dmuth/wordpress-with-nginx-and-letsencrypt/projects" href="/dmuth/wordpress-with-nginx-and-letsencrypt/projects">
      ...
      <a itemprop="url" class="js-selected-navigation-item reponav-item" data-selected-links="security alerts policy code_scanning /dmuth/wordpress-with-nginx-and-letsencrypt/security/advisories" href="/dmuth/wordpress-with-nginx-and-letsencrypt/security/advisories">
        <span itemprop="name">Security</span>
        <meta itemprop="position" content="6">
</a>
      <a class="js-selected-navigation-item reponav-item" data-selected-links="pulse /dmuth/wordpress-with-nginx-and-letsencrypt/pulse" href="/dmuth/wordpress-with-nginx-and-letsencrypt/pulse">
        Pulse
</a>
    ...
    <include-fragment class="select-menu-loading-overlay anim-pulse">
      <svg height="32" class="octicon octicon-octoface" viewBox="0 0 16 16" version="1.1" width="32" aria-hidden="true"><path fill-rule="evenodd" d="M14.7 5.34c.13-.32.55-1.59-.13-3.31 0 0-1.05-.33-3.44 1.3-1-.28-2.07-.32-3.13-.32s-2.13.04-3.13.32c-2.39-1.64-3.44-1.3-3.44-1.3-.68 1.72-.26 2.99-.13 3.31C.49 6.21 0 7.33 0 8.69 0 13.84 3.33 15 7.98 15S16 13.84 16 8.69c0-1.36-.49-2.48-1.3-3.35zM8 14.02c-3.3 0-5.98-.15-5.98-3.35 0-.76.38-1.48 1.02-2.07 1.07-.98 2.9-.46 4.96-.46 2.07 0 3.88-.52 4.96.46.65.59 1.02 1.3 1.02 2.07 0 3.19-2.68 3.35-5.98 3.35zM5.49 9.01c-.66 0-1.2.8-1.2 1.78s.54 1.79 1.2 1.79c.66 0 1.2-.8 1.2-1.79s-.54-1.78-1.2-1.78zm5.02 0c-.66 0-1.2.79-1.2 1.78s.54 1.79 1.2 1.79c.66 0 1.2-.8 1.2-1.79s-.53-1.78-1.2-1.78z"/></svg>
        ...
        <div class="BtnGroup flex-shrink-0 d-md-none">
          <a href="/dmuth/wordpress-with-nginx-and-letsencrypt/find/master"
